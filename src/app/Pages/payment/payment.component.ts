...
export class PaymentComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.validationForm = new FormGroup({
      id: new FormControl(''),
      number: new FormControl('', [Validators.required, Validators.pattern(/^[0-9]\d*$/), Validators.min(0)]),
      name: new FormControl('', [Validators.required, Validators.minLength(3), Validators.maxLength(3), Validators.pattern('^[a-zA-Z ]*$')]),
